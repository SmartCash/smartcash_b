...
allowing somebody to distribute a SmartCash-Qt.app or smartcash-qt-setup.exe with a valid
...
that the smartcash-qt.exe file inside the installer had not been tampered with.
