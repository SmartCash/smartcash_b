SmartCash Core version 0.9.4 is now available from:

  https://smartcash.org/bin/0.9.4/
...
this update is incompatible with the SmartCash system and could lead to consensus
forks.

SmartCash Core released binaries from https://smartcash.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~smartcash/+archive/ubuntu/smartcash
- A third-party or self-compiled SmartCash Core

upgrade to SmartCash Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
