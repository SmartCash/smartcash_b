SmartCash Core version 0.9.2.1 is now available from:

  https://smartcash.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SMARTCASH to 0.01 SMARTCASH
...
- Fix "Start smartcash on system login"
