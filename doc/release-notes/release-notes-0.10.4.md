SmartCash Core version 0.10.4 is now available from:

  <https://smartcash.org/bin/smartcash-core-0.10.4/>
...
- #6953 `43c2789` Split smartcash-tx into its own package
- #6953 `dfe0d4d` Include smartcash-tx binary on Debian/Ubuntu
