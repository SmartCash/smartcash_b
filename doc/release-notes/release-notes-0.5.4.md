SmartCash version 0.5.4 is now available for download at:
http://sourceforge.net/projects/smartcash/files/SmartCash/smartcash-0.5.4/
...
http://gitorious.org/smartcash/smartcashd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix SmartCash-Qt notifications under Growl 1.3.
Increase required age of SmartCash-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSmartCash properly when installing SmartCash-Qt over it. (Windows)
