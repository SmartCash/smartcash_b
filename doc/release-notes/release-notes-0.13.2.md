SmartCash Core version 0.13.2 is now available from:

  <https://smartcash.org/bin/smartcash-core-0.13.2/>
...
- #8908 `4a974b2` Update smartcash-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow smartcash-tx to create v2 transactions (btcdrak)
