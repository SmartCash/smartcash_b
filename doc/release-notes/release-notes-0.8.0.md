SmartCash-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/smartcash/files/SmartCash/smartcash-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the SmartCash
...
New/changed settings (command-line or smartcash.conf file)
--------------------------------------------------------
