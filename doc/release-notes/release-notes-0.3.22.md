Download URL: https://sourceforge.net/projects/smartcash/files/SmartCash/smartcash-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 SMARTCASH fee schedule (users still pay 0.01 SMARTCASH per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #smartcash00 - #smartcash99
