...
/** SmartCash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SmartCashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SmartCashUnits(QObject *parent);

    /** SmartCash units.
      @note Source: https://en.smartcash.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SMARTCASH,
...
typedef SmartCashUnits::Unit SmartCashUnit;
