    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return SmartCashUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, SmartCashUnits::separatorNever);
            else
                return SmartCashUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != NULL) ? tr("Requested") + " ("+SmartCashUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
