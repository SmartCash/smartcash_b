...
// NOTE: Unlike wallet RPC (which use SMARTCASH values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
UniValue getblocktemplate(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "    https://github.com/smartcash/bips/blob/master/bip-0022.mediawiki\n"
            "    https://github.com/smartcash/bips/blob/master/bip-0023.mediawiki\n"
            "    https://github.com/smartcash/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
            "    https://github.com/smartcash/bips/blob/master/bip-0145.mediawiki\n"
...
UniValue submitblock(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "See https://en.smartcash.it/wiki/BIP_0022 for full specification.\n"
...
UniValue estimatesmartfee(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"feerate\" : x.x,     (numeric) estimate fee-per-kilobyte (in SMARTCASH)\n"
