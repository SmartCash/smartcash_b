...
class RawTransactionsTest(SmartCashTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid smartcash address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        # send 1.2 SMARTCASH to msig addr
