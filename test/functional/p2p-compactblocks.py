...
# TestNode: A peer we use to send messages to smartcashd, and store responses.
...
class CompactBlocksTest(SmartCashTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes smartcashd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that smartcashd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for smartcashd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # smartcashd will not send blocktxn responses for blocks whose height is
